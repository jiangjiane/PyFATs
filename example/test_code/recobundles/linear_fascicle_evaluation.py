...
fbval = '/home/brain/workingdir/data/dwi/hcp/preprocessed/response_dhollander/100408/Diffusion/data/bvals'
fbvec = '/home/brain/workingdir/data/dwi/hcp/preprocessed/response_dhollander/100408/Diffusion/data/bvecs'
bvals, bvecs = read_bvals_bvecs(fbval, fbvec)
gtab = gradient_table(bvals, bvecs)



stream = nib.streamlines.tck.TckFile.load('/home/brain/workingdir/data/dwi/hcp/preprocessed/response_dhollander/'
                                          '100408/Diffusion/SD/1M_20_01_20dynamic250_SD_Stream_occipital5.tck')
candidate_sl = stream.streamlines
hdr = stream.header
