...
fib = '/home/brain/workingdir/data/dwi/hcp/preprocessed/' \
      'response_dhollander/subjects/100206/Diffusion/tractography/Det/results/l_vis_centroids_all_subjects.tck'
...
qb = QuickBundles(streamlines, 8)
clusters = qb.clusters()
print len(clusters)
# print clusters[1]['hidden']
# print clusters[1]['N']
...
label_endpoints = fibcluster.endpoints_seg(mode='lh', thre=8)
