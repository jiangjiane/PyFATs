...
if __name__ == '__main__':
    # load data
    fname = '/home/brain/workingdir/data/dwi/hcp/preprocessed/response_dhollander/' \
            '100206/Structure/T1w_acpc_dc_restore_brain1.25.nii.gz'
    img = nib.load(fname)
    data = img.get_data()
    # fname = '/home/brain/workingdir/data/dwi/hcp/preprocessed/response_dhollander/' \
    #         '100206/Diffusion/SD/1M_20_01_20dynamic250_SD_Stream_lhemi_occipital5_vis_interface.tck'
    # tckimg = TckFile.load(fname)
    # data = tckimg.streamlines
