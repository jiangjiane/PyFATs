...
#            'response_dhollander/subjects/100206/T1w_acpc_dc_restore_brain1.25.nii.gz'
# roi_vis = '/home/brain/workingdir/data/dwi/hcp/preprocessed/' \
#           'response_dhollander/subjects/100206/ROI/Native_cytoMPM_thr25_vis.nii.gz'
# fib_file = '/home/brain/workingdir/data/dwi/hcp/preprocessed/' \
#            'response_dhollander/subjects/100206/Diffusion/tractography/' \
#            'Det/SD_Stream_angle20_cutoff0.1_length50_250_seedFP_roiOccipital_L_100k_rh.tck'
...
# tck_name = ['Diffusion/tractography/Det/results/l_vis.tck',  # l_vis_centroids_all_subjects.tck',
#             'Diffusion/tractography/Det/results/r_vis.tck']  # r_vis_centroids_all_subjects.tck']
# tck_name = [tck_name[1]]
# tck_name = ['Diffusion/tractography/Det/SD_Stream_angle20_cutoff0.1_length50_250_seedFP_roiOccipital_L_100k_rh.tck',
#             'Diffusion/tractography/Det/SD_Stream_angle20_cutoff0.1_length50_250_seedFP_roiOccipital_R_100k_lh.tck']
# tck_name = ['Diffusion/tractography/Det/SD_Stream_angle20_cutoff0.1_length50_250_seedFP_100k.tck']
# tck_name = ['callosum.tck']
# tck_name = ['lh.tck', 'rh.tck']
...
# tck_name = ['SD_Stream_angle20_cutoff0.1_length50_250_seedOccipital_roicallosum_L_100k.tck',
#             'SD_Stream_angle20_cutoff0.1_length50_250_seedOccipital_roicallosum_R_100k.tck']

vol_name = 'T1w_acpc_dc_restore_brain1.25.nii.gz'
# vol_name = 'MNI152_T1_1mm_brain.nii.gz'

results_dir = 'Diffusion/tractography/Det/new_results'
# results_dir = 'Diffusion/tractography/Det'
...
# for sub in sessid:
#     dir_f = os.path.join(subjects_dir, sub, new_results_dir)
    ...
    for j in xrange(len(tck_name)):
        ...
        def modify_left_button_callback(i_ren, obj, button):
            ...
            if button.current_icon_id == 0:
                ...
                fas.save2tck(os.path.join(file_select_menu.current_directory, '%s.tck') % text.text)
        ...
        file_select_menu = ui.FileSelectMenu2D(size=(300, 500),
                                               ...
                                               font_size=16,
                                               extensions=["tck", "gz"],
                                               directory_path=current_directory,  # os.getcwd(),
                                               parent=None)
